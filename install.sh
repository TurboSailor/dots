...
sudo pacman -S meson neovim zsh tmux xclip bat lsd neofetch conky sxhkd bspwm kitty feh rofi flameshot networkmanager pavucontrol pulseaudio pulseaudio-alsa keychain playerctl brightnessctl obsidian keepassxc thunar thunar-archive-plugin thunar-media-tags-plugin --noconfirm
