...
yes | yay -S picom-simpleanims-next-git youtube-music-bin visual-studio-code-bin pcloud-drive koodo-reader-bin
...
sudo pacman -S meson neovim zsh tmux xclip bat lsd neofetch conky sxhkd bspwm polybar kitty feh rofi flameshot networkmanager pavucontrol pulseaudio pulseaudio-alsa keychain playerctl brightnessctl obsidian keepassxc thunar thunar-archive-plugin thunar-media-tags-plugin --noconfirm
